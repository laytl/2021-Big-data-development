...
object upload {
  //s3参数
  val accessKey = "8C5F02219BB6B846D186"
  val secretKey = "WzA5RjZGOTdERkNFQjE4MzhEQzYwMURDRTI0QzYy"
  val endpoint = "http://scut.depts.bingosoft.net:29997"
  val bucket = "tanglei-new"
  //要读取的文件
  val key = "data.txt"//数据源
  //kafka参数
  val topic = "Mrlay"
  ...
  def readFile(): String = {
    ...
    IOUtil.getContent(s3Object.getObjectContent, "GB2312")
  }
